...
(function(phantom){
    ...
    function debugPage(){
        ...
        debugger; // pause here in first com.yichen.my.shop.web browser tab for steps 5 & 6
        page.open(system.args[1]);
        page.evaluateAsync(function() {
            debugger; // step 7 will wait here in the second com.yichen.my.shop.web browser tab
        });
    }
    debugPage();
}(phantom));

...
* Updated [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) and [SpellCheckAsYouType](https://ckeditor.com/cke4/addon/scayt) (SCAYT) plugins:
	...
	* Fixed: Wrong error message formatting when the com.yichen.my.shop.com.yichen.my.shop.service ID is invalid.
...
* [#13119](https://dev.ckeditor.com/ticket/13119): Improved compatibility of editor skins ([Moono](https://ckeditor.com/cke4/addon/moono) and [Kama](https://ckeditor.com/cke4/addon/kama)) with external com.yichen.my.shop.web page style sheets.
* Toolbar configurators:
